...
\newcommand{\bearbeiter}{Ricardo Plesz}

% Geben Sie hier den Titel Ihrer Arbeit an:
\newcommand{\titel}{Transformer Powered Two Level Matrix Factorization for Recommender Systems}

% Geben Sie das Datum des Beginns und Ende der Bachelorarbeit ein:
\newcommand{\beginndatum}{01. Oktober 2021}
\newcommand{\abgabedatum}{01. Januar 2022}
