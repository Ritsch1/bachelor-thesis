...
\ifthenelse{\boolean{\biber}}{
	...
	\usepackage[style=numeric,natbib=true,backend=biber,mincitenames=1,maxcitenames=2,maxbibnames=99,uniquelist=false,dashed=false,sorting=none]{biblatex}
...
\ifthenelse{\equal{\sprache}{englisch}}{
 \usepackage[]{babel}
 % Bibtex u.a -> et al.
 \ifthenelse{\boolean{\biber}}{
...
\newacronym{aps}{APS}{Automated Persuasion System}
\newacronym{bpdt}{BDT}{Bi - Party Decision Theory}
\newacronym{cf}{CF}{Collaborative Filtering}
\newacronym{fn}{FN}{False Negative}
\newacronym{fp}{FP}{False Positive}
\newacronym{iautorec}{I - AutoRec}{Item - AutoRec}
\newacronym{idc}{IDC}{International Data Corporation}
\newacronym{mmse}{MMSE}{Masked Mean Squared Error}
\newacronym{nlp}{NLP}{Natural Language Processing}
\newacronym{nn}{NN}{Nearest Neighbor}
\newacronym{poc}{PoC}{Prediction of Conviction}
\newacronym{pow}{PoW}{Prediction of Weight}
\newacronym{rmse}{RMSE}{Root Mean Squared Error} 
\newacronym{tfidf}{TFIDF}{Term Frequency Inverse Document Frequency}
\newacronym{tlmf}{TLMF}{Two Level Matrix Factorization}
\newacronym{tn}{TN}{True Negative}
\newacronym{tp}{TP}{True Positive}
\newacronym{uautorec}{U - AutoRec}{User - AutoRec}
\newacronym{wtmf}{WTMF}{Weighted Textual Matrix Factorization}
\glssetwidest{  U - AutoRec}
...
\vspace*{-1.5cm}
  ...
  \hfill
  \raisebox{7mm}{
  \includegraphics[width=130pt]{images/HHU_Logo}}
  \vspace{14em}
